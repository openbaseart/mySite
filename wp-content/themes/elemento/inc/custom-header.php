...
function elemento_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'elemento_custom_header_args', array(
		...
		'flex-height'            => true,
		'video' 				 => true,
		'wp-head-callback'       => 'elemento_header_style',
	) ) );
}
add_action( 'after_setup_theme', 'elemento_custom_header_setup' );

if ( ! function_exists( 'elemento_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see elemento_custom_header_setup().
	 */
	function elemento_header_style() {
